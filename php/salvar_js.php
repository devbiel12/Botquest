...
<body  id="home">
    <aside id="aside">
        ...
        <p id="pAConteudo">Parabens por ter concluido seu teste de HTML5 no Botquest, porém você ainda está no começo da jornada de programação, continue estudando os outros topicos para ter uma melhor noção de como fazer seu primeiro site</p>
    </aside>

    <h1 id="titleResultados">Resultado Html</h1>
    <section id="corpoTeste">
        <div id="ResultadoTeste">
           ...
           if($p1 == "a"){
            ...
            echo "1 - Resposta Errada! Correta: 1º Alternativa<br><br>";
           }
           ...
           if($p2 == "a"){
            ...
            echo "2 - Resposta Errada! Correta: 1º Alternativa<br><br>";
           }
           ...
           if($p3 == "a"){
            ...
            echo "3 - Resposta Errada! Correta: 1º Alternativa<br><br>";
           }
           ...
           if($p4 == "a"){
            ...
            echo "4- Resposta Errada! Correta: 1º Alternativa<br><br>";
           }
           ...
           if($p6 == "a"){
            ...
            echo "6 - Resposta Errada! Correta: 1º Alternativa<br><br>";
           }
           ...
           if($p7 == "a"){
            ...
            echo "7 - Resposta Errada! Correta: 1º Alternativa<br><br>";
           }
           ...
           if($p8 == "a"){
            ...
            echo "8 - Resposta Errada! Correta: 1º Alternativa<br><br>";
           }
           ...
           if($p9 == "a"){
            ...
            echo "9 - Resposta Errada! Correta: 1º Alternativa<br><br>";
           }
           ...
           if($p10 == "a"){
            ...
            echo "10 - Resposta Errada! Correta: 1º Alternativa<br><br>";
           }

           echo "<h1>Nota: ".$nota."</h1><br>";

           $sql -> query("insert into prova(nome, data, nota, materia)value('$nome', '$hoje','$nota', 'js')");
           ?></p>
    </div>
    </section>
