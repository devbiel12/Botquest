    ...
    <section id="corpoTeste">
        <div id="ResultadoTeste">
           ...
           if($p4 == "b"){
            ...
            echo "4- Resposta Errada! Correta: 2º Alternativa<br><br>";
           }
           ...
           $sql -> query("insert into prova(nome, data, nota, materia)value('$nome', '$hoje','$nota', 'html')");
           ?></p>
    </div>
    </section>
