...
<body  id="home">
    <aside id="aside">
        ...
        <p id="pAConteudo">Parabens por ter concluido seu teste de PHP no Botquest, porém você ainda está no começo da jornada de programação, continue estudando os outros topicos para ter uma melhor noção de como fazer seu primeiro site</p>
    </aside>

    <h1 id="titleResultados">Resultado Php</h1>
    <section id="corpoTeste">
        <div id="ResultadoTeste">
           ...
           if($p1 == "c"){
            ...
            echo "1 - Resposta Errada! Correta: 3º Alternativa<br><br>";
           }
           ...
           if($p3 == "b"){
            ...
            echo "3 - Resposta Errada! Correta: 2º Alternativa<br><br>";
           }
           ...
           if($p5 == "b"){
            ...
            echo "5 - Resposta Errada! Correta: 2º Alternativa<br><br>";
           }
           ...
           if($p9 == "c"){
            ...
            echo "9 - Resposta Errada! Correta: 3º Alternativa<br><br>";
           }
           ...
           $sql -> query("insert into prova(nome, data, nota, materia)value('$nome', '$hoje','$nota', 'php')");
           ?></p>
    </div>
    </section>
