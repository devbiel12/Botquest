   ...
   <section id="sectionAdmin">
    <div>
      <form method="POST" action="validaadmin.php">
        <h1 id="titleAdmin">Area Restrita</h1>
        <p id="usuarioAdmin">Usuario</p>
        <input type="text" id="usuarioAT" name="usuario" required>
        <p id="senhaAdmin">Senha</p>
        <input type="password" id="senhaAT" name="senha" required>
        <input type="submit" value="Logar" id="butLogar" name="logar"></a>
      </form>
    </div>
   </section>
    <footer id="footerLog">
